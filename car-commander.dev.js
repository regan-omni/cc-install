...
function submitSearch() {
  ...
  if (hasErrors === false) {
    ...
    window.open("https://www.vsufcu.org/car-commander#CarBuyingServicePage=/search;condition=" + conditionInput.value + ';makes=' + makeInput.value + ';model=' + modelInput.value + ';zip=' + zipInput.value);
  }
}